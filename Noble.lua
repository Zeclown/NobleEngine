...
function Noble.setConfig(__configuration)
    ...
    if __configuration.defaultTransition ~= nil then
        configuration.defaultTransition = __configuration.defaultTransition
    end
    if __configuration.defaultTransitionDuration ~= nil then
        configuration.defaultTransitionDuration = __configuration.defaultTransitionDuration
    end
    if __configuration.defaultTransitionHoldTime ~= nil then
        configuration.defaultTransitionHoldTime = __configuration.defaultTransitionHoldTime
    end
    if __transitionDurationIncludesHoldTime ~= nil then
        configuration.transitionDurationIncludesHoldTime = __configuration.transitionDurationIncludesHoldTime
    end
    ...
    if __configuration.enableDebugBonkChecking ~= nil then
        ...
        if configuration.enableDebugBonkChecking == true then
            Noble.Bonk.enableDebugBonkChecking()
        end
    end
...
function Noble.transition(NewScene, __duration, __transition, __transitionProperties, __sceneProperties)
    ...
    currentTransition = (__transition or configuration.defaultTransition)(__duration or configuration.defaultTransitionDuration, __transitionProperties or {})
end
